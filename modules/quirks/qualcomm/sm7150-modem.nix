...
{
  options.mobile = {
    quirks.qualcomm.sm7150-modem.enable = mkOption {
      type = types.bool;
      default = false;
      description = lib.mdDoc ''
        Enable this on a mainline-based SM7150 device for modem support
      '';
    };
  };
        ...
        runCommand "qcom-modem-uncompressed-firmware-share" {
          firmwareFiles = buildEnv {
            ...
            pathsToLink = [
              ...
              ++ optional cfg.sm7150-modem.enable "/lib/firmware/qcom/sm7150"
            ;
          };
        } ''
          PS4=" $ "
